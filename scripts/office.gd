...
func _build_agent_dialogs() -> void:
	...
	form_box.custom_minimum_size = Vector2(420.0, 0.0)
	_agent_form_dialog.add_child(form_box)
	...
	detail_box.custom_minimum_size = Vector2(460.0, 0.0)
	_agent_detail_dialog.add_child(detail_box)

	_agent_detail_text = RichTextLabel.new()
	_agent_detail_text.fit_content = true
	_agent_detail_text.scroll_active = false
